...
const places = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1586179935424-5c27c4e87f5e?w=400&q=80",
  },
  {
    name: "Sarnath",
...
const features = [
  {
    ...
    description:
      "Experience the holy city where millions seek moksha. The Ganges grants purification to all who bathe in its waters.",
    icon: "🕉️",
  },
  {
    title: "Ancient Temples",
    description:
      "Explore thousands of temples including the sacred Kashi Vishwanath, a beacon of divine worship for centuries.",
    icon: "🏛️",
  },
  {
    title: "Ganges Boat Ride",
    description:
      "Witness the magical Ganga Aarti and sunrise over the ghats from a traditional boat - a once-in-a-lifetime experience.",
    icon: "⛵",
  },
  {
    title: "Yoga & Meditation",
    description:
      "Find inner peace with yoga sessions and meditation retreats along the sacred banks of the Ganges.",
    icon: "🧘",
  },
];
...
export default function VaranasiPage() {
  ...
  return (
    <main className="min-h-screen">
      <section ref={ref} className="relative h-screen overflow-hidden">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1586179935424-5c27c4e87f5e?w=1920&q=80')",
            }}
          />
          <motion.div
        ...
        <motion.div
          className="absolute top-20 left-10 w-64 h-64 rounded-full bg-[#8B4513]/10 blur-3xl"
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1.2, delay: 0.2 }}
        />
        <motion.div
          className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-[#8B4513]/5 blur-3xl"
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center h-full flex items-center justify-center">
          <div>
            ...
            >
              Discover Varanasi -{" "}
              <span className="text-[#E38B29]">The Spiritual Capital</span>
            </motion.h1>
            ...
            >
              Ancient ghats, sacred rituals, and timeless spirituality
            </motion.p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="font-['Inter'] text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Discover what makes Varanasi a must-visit destination for spiritual
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="font-['Inter'] text-gray-600 mb-8">
              Connect with local experts who know Varanasi like their own
              backyard
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h2
            ...
            transition={{ duration: 0.6 }}
          >
            Varanasi Guide Pricing
          </motion.h2>
          <p className="font-['Inter'] text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Choose the perfect companion for your Varanasi adventure
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-[#8B4513] to-[#6d3610]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="font-['Inter'] text-white/80 mb-8 max-w-xl mx-auto">
              Let us help you create the perfect Varanasi experience with our
              expert local guides
            </p>

            <Link
              href="/request"
              className="font-['Inter'] inline-block px-10 py-5 bg-white text-[#8B4513] rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
              Plan Your Varanasi Trip
            </Link>
          </motion.div>

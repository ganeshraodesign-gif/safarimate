...
const places = [
  ...
  {
    name: "Lal Bagh",
    image: "https://images.unsplash.com/photo-1567349822118-e1ff6762f85c?w=400&q=80",
  },
  {
    name: "Cubbon Park",
  ...
  {
    name: "MG Road",
    image: "https://images.unsplash.com/photo-1572297794908-3339997031d6?w=400&q=80",
  },
  {
    name: "Bannerghatta",
    image: "https://images.unsplash.com/photo-1564562974072-59096a4c6ba9?w=400&q=80",
  },
];
...
const features = [
  {
    ...
    description:
      "Explore the Silicon Valley of India, home to tech giants, startups, and innovation hubs.",
    icon: "💻",
  },
  {
    title: "Green Spaces",
    description:
      "Relax in lush gardens and parks that give Bangalore its nickname 'Garden City'.",
    icon: "🌳",
  },
  {
    title: "Startup Culture",
    description:
      "Experience the entrepreneurial spirit and vibrant startup ecosystem driving India's tech revolution.",
    icon: "🚀",
  },
  {
    title: "Cosmopolitan Food",
    description:
      "Savor diverse cuisines from traditional South Indian to international flavors.",
    icon: "🍛",
  },
];
      ...
      <section ref={ref} className="relative h-screen overflow-hidden">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1555658636-6e4a36218a93?w=1920&q=80')",
            }}
          />
          <motion.div
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center h-full flex items-center justify-center">
          <div>
            ...
            >
              Explore Bangalore -{" "}
              <span className="text-[#E38B29]">Silicon Valley of India</span>
            </motion.h1>
            ...
            >
              Modern tech hub meets rich cultural heritage
            </motion.p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="font-['Inter'] text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Discover what makes Bangalore a must-visit destination for travelers
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="font-['Inter'] text-gray-600 mb-8">
              Connect with local experts who know Bangalore like their own backyard
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <motion.h2
            ...
            transition={{ duration: 0.6 }}
          >
            Bangalore Guide Pricing
          </motion.h2>
          <p className="font-['Inter'] text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Choose the perfect companion for your Bangalore adventure
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="font-['Inter'] text-white/80 mb-8 max-w-xl mx-auto">
              Let us help you create the perfect Bangalore experience with our
              expert local guides
            </p>
